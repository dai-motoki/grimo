...
import i18n
# 翻訳ファイルをロード
i18n.load_path.append(_os.path.join(_os.path.dirname(__file__), 'i18n'))
...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    def __init__(self,
        ...
        self._positionals = add_group(_(i18n.t('message.positional_argument')))
        self._optionals = add_group(_(i18n.t('message.options')))
        ...
        if self.add_help:
            self.add_argument(
                ...
                help=i18n.t('message.show_help_message_and_exit'))
    ...
    def _parse_known_args(self, arg_strings, namespace):
        ...
        if required_actions:
            self.error(_(i18n.t('message.the_following_arguments_are_required')+'%s') %
    ...
    def error(self, message):
        ...
        self.exit(2, _('%(prog)s: '+i18n.t('message.error')+' %(message)s\n') % args)
